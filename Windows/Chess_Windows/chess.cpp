...
bool CHESS::hod(int figure, int user_hod)
{
    int figure_j = figure / 10;
    int figure_i = figure % 10;

    int buff = chess_map[figure_i][figure_j];
    if(buff < 7)
...
bool CHESS::hod_player_2(int figure, int user_hod)
{
    //получаем координаты
    int figure_j = figure / 10;
    int figure_i = figure % 10;
...
void CHESS::peshka_hod(int figure_i, int figure_j,
...
void CHESS::hod_ladya(int figure_i, int figure_j,
                int user_hod_i, int user_hod_j, int player)
{
...
bool CHESS::proverka_ladya(int figure_i, int figure_j,
...
void CHESS::hod_konb(int figure_i, int figure_j,
              int user_hod_i, int user_hod_j, int player)
{
...
void CHESS::hod_ferz(int figure_i, int figure_j,
              int user_hod_i, int user_hod_j, int player)
{
    int j = 0;
...
void CHESS::hod_corol(int figure_i, int figure_j,
               int user_hod_i, int user_hod_j, int player)
{
...
void CHESS::hod_coroleva (int figure_i, int figure_j,
                   int user_hod_i, int user_hod_j, int player)
{
    int buff = chess_map[user_hod_i][user_hod_j];
