...
#include <memory>
#include "../worked/CHESS_ANDROID/CHESS-PROJECT-main/Chess_Windows/client.h"
...
Q_CONSTINIT static const qt_meta_stringdata_Client_t qt_meta_stringdata_Client = {
    {
        ...
        QT_MOC_LITERAL(7, 15),  // "signalReadyRead"
        QT_MOC_LITERAL(23, 0),  // ""
        QT_MOC_LITERAL(24, 13)   // "slotReadyRead"
    },
    "Client",
    "signalReadyRead",
    "",
...
void Client::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->signalReadyRead(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &Client::signalReadyRead; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
